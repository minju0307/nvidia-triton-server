...
def build_engine():
    ...
    for precision in BUILD:
        ...
        profile.set_shape("input_ids", (64,seq_len), (64,seq_len), (64,seq_len))
        profile.set_shape("attention_mask", (64,seq_len), (64,seq_len), (64,seq_len))
        profile.set_shape("token_type_ids", (64, seq_len), (64, seq_len), (64, seq_len))
...
def test_engine():
    ...
    for precision in TEST:
        ...
        token_type_ids = torch.randint(0, 1, (batch_size, seq_len), dtype=torch.long, device=gpu)
